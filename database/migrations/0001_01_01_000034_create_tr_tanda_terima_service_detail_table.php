...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tr_tanda_terima_service_detail', function (Blueprint $table) {
            ...
            $table->uuid('tanda_terima_servide_id');
            $table->foreign('tanda_terima_servide_id')->references('id')->on('tr_tanda_terima_service_header')->onDelete('cascade')->onUpdate('cascade');
