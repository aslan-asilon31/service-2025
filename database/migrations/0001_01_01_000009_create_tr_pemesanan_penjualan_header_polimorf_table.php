...
return new class extends Migration
{
    ...
    {
        Schema::create('tr_pemesanan_penjualan_header_polimorf', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('pemesanan_penjualan_id');
            $table->string('pemesanan_penjualan_tipe');
    ...
    {
        Schema::dropIfExists('tr_pemesanan_penjualan_header_polimorf');
    }
};
