...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tr_sp_mutasi_gudang_terima_detail', function (Blueprint $table) {
            ...
            $table->uuid('mutasi_gudang_terima_id');
            $table->foreign('mutasi_gudang_terima_id', 'fk_mutasi_gudang_terima_id')->references('id')->on('tr_sp_mutasi_gudang_terima_header')->onDelete('cascade')->onUpdate('cascade');
